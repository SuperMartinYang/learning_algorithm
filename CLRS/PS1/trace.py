...
class TraceRecord(object):
    ...
    def getMaximum(self,arguments, maximum):
        """
        A function for recording the fact that the getMaximum function of some subproblem
        has been called
    ...
    def getBetterNeighbor(self,neighbor, better):
        """
        A function for recording the fact that the getBetterNeighbor function of some
        subproblem has been called.
    ...
    def setBestSeen(self, bestSeen):
        """
        A function for recording the fact that the variable "bestSeen" has been updated
